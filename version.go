// Copyright ©2019 The mlpack Authors. All rights reserved.
...
const root = "mlpack.org/v1"

// Version returns the version of mlpack and its checksum. The returned
// values are only valid in binaries built with module support.
//
// If a replace directive exists in the mlpack go.mod, the replace will
